...
type HTTPHandler = EventHandler | FetchableObject | H3Core;
...
type LazyEventHandler = () => EventHandler | FetchableObject | Promise<EventHandler | FetchableObject>;
 ...
 */
type ComposedMiddleware = (event: H3Event, handler: EventHandler) => unknown | Promise<unknown>;
/**
 ...
 */
declare function composeMiddleware(middleware: Middleware[]): ComposedMiddleware;
...
type MatchedRoute<T = any> = {
  data: T;
  params?: Record<string, string>;
};
type HTTPMethod = "GET" | "HEAD" | "PATCH" | "POST" | "PUT" | "DELETE" | "CONNECT" | "OPTIONS" | "TRACE" | "QUERY";
interface H3Config {
  /**
...
type H3CoreConfig = Omit<H3Config, "plugins">;
...
type H3 = H3$1;
export { ComposedMiddleware, type CookieSerializeOptions, DynamicEventHandler, ErrorBody, ErrorDetails, ErrorInput, EventHandler, EventHandlerFetch, EventHandlerObject, EventHandlerRequest, EventHandlerResponse, EventHandlerWithFetch, FetchHandler$1 as FetchHandler, FetchableObject, H3, H3$1, H3Config, H3Core, H3CoreConfig, H3Event, H3EventContext, H3Plugin, H3Route, H3RouteMeta, HTTPError, HTTPEvent, HTTPHandler, HTTPMethod, InferEventInput, LazyEventHandler, MatchedRoute, MaybePromise, Middleware, MiddlewareOptions, PreparedResponse, RouteOptions, RouteRules, RouterContext, Session, SessionConfig, SessionData, SessionManager, type TypedRequest, TypedServerRequest, callMiddleware, clearSession, composeMiddleware, defineMiddleware, definePlugin, getSession, sealSession, toMiddleware, unsealSession, updateSession, useSession };