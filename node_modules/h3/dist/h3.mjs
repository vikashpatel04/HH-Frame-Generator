...
function getRouterParams(event, opts = {}) {
	...
	if (opts.decode) {
		params = { ...params };
		for (const key in params) params[key] = decodeRouterParam(params[key]);
	}
	return params;
}
...
function decodeRouterParam(value) {
	...
	let result = "";
	let lastIndex = 0;
	ENCODED_SEP_RE_G$1.lastIndex = 0;
	for (let m; m = ENCODED_SEP_RE_G$1.exec(value);) {
...
var EventStream = class extends HTTPResponse {
	...
	constructor(event, _opts = {}) {
		...
		onDispose$1(this._event, () => this.close());
	}
	async push(message) {
